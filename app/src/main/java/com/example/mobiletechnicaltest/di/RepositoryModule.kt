...
import com.example.mobiletechnicaltest.data.remote.ProductApiService
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideProductApi(api: Retrofit): ProductApiService {
        return api.create(ProductApiService::class.java)
    }
}
